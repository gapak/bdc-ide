        ...
        <div className="radio">
          <label>
            <input type="radio" value={key}
                   checked={(() => {
                     return this.state[stat] === key;
                   })()}
                   onChange={(changeEvent) => {
                     this.customOptionChange(changeEvent, stat);
                   }}/>
            {text}
          </label>
        </div>;
    ...
    const make_select = (stat, options) =>
        <div className={stat}>
          <Select
              ...
              value={this.state[stat]}
              onChange={(changeEvent) => {
                this.customOptionChange(changeEvent, stat, false);
              }}
              options={options}
          />
        </div>;
              ...
              <table className="table">
                ...
                {this.state.cards.map((row) =>
                    <tr key={row._id}>
                      ...
                      <td>{row.acting}</td>
                      <td>
                        <button className="btn btn-danger" onClick={() => this.deleteCard(row._id)}> Delete</button>
                      </td>
                      <td>
                        <button className="btn btn-warning" onClick={() => this.initCardEdit(row._id)}> Edit</button>
                      </td>
                    </tr>
                )}
                </tbody>
